...
// Notation of JS object:
let person = {
    sentence:'My name is',
    first_name: 'Emma',
    last_name: 'Gmazel.',
    email: 'gmaz0001@algonquinlive.com.'
};

console.log(person.first_name); // Emma
console.log(person.last_name); // Gmazel
console.log(person.email); // gmaz0001@algonquinlive.com
console.log(person);
